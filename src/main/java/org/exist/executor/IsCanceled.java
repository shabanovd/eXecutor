 ...
 *
 */
public class IsCanceled extends BasicFunction {

    public final static FunctionSignature signatures[] = {
            new FunctionSignature(
                    new QName("is-canceled", NAMESPACE_URI, PREFIX),
                    "Check is task canceled.",
                    new SequenceType[] {
    ...
    public IsCanceled(XQueryContext context, FunctionSignature signature) {
